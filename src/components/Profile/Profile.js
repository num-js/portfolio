...
const Profile = () => {
    return (
        <>
            <div className="App" style={{ background: `url("../backgrounds/bg-circles.svg")`, backgroundPositionX: "-150%", backgroundPositionY: "54%", backgroundRepeat: "inherit", paddingTop: "80px" }}>
                <ProfileText />
                <ProfilePicture />
            </div>
