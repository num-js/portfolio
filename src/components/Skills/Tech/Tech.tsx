...
import type { OrbitSkill } from '../../../types/skillsData';
...
type TechProps = {
    ...
    skill: { details?: OrbitSkill };
    showSkillPopover: (event: MouseEvent<HTMLImageElement>, details: OrbitSkill | undefined) => void;
};
