...
import type { OrbitSkill, SkillDetail, SkillProject } from '../../types/skillsData';

const Skills = () => {
    const [skillImgElem, setSkillImgElem] = useState<HTMLElement | null>(null);
    const [skillDetails, setSkillDetails] = useState<SkillDetail | null>(null);

    const openPopover = Boolean(skillImgElem);
    const popoverId = openPopover ? 'simple-popover' : undefined;

    const showSkillPopover = (event: MouseEvent<HTMLButtonElement>, skill: OrbitSkill) => {
        setSkillImgElem(event.currentTarget);
        setSkillDetails(skill as SkillDetail);
    };
                    ...
                    >
                        <div className="relative pt-3">
                            ...
                            <div className="group/repos grid grid-cols-1 gap-3">
                                {skillDetails?.projects?.map((project: SkillProject, index: number) => (
                                    <div
                                        key={index}
                                    ...
                                    >
                                        ...
                                        <div className="mt-2 flex justify-around">
                                            ...
                                            {project.links.code && (
                                                <span>
                                                    <a target="_blank" rel="noreferrer" href={project.links.code}>
