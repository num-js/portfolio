        ...
        <>
            <section className="my-10 mb-32 text-gray-600 body-font lg:mt-10 lg:mx-20">
                <SectionHeader
                    ...
                    sectionIcon={<svg version="1.1" id="svg4619" x="0px" y="0px" width="22px" height="22px" viewBox="0 0 15 15" style={{ enableBackground: "new 0 0 15 15" }}>
                                    ...
                                    <div key={index} className={`flex relative ${index !== (academicsData.length - 1) ? 'pb-12' : 'pb-4'}`}>
                                        ...
                                        <div className="flex-grow pl-4 text-base">
                                            ...
                                            <div className="leading-relaxed text-white/80">
                                                ...
                                                <span className="mt-1 font-medium text-white/50">
