export default function ({ btnTxt, btnClass }) {
    return (
        <div className={"relative inline-flex items-center justify-start py-2 pl-4 pr-12 overflow-hidden font-semibold text-[#52af77] transition-all duration-150 ease-in-out rounded bg-gray-100 dark:bg-gray-800 dark:text-[#52af77] hover:pl-10 hover:pr-6 group w-full cursor-pointer active:scale-95 " + (btnClass ? btnClass : '')}>
