function AnimatedHoverButton({ btnTxt, btnClass }) {
    return (
        <div className={"relative inline-flex w-full cursor-pointer items-center justify-start overflow-hidden rounded-md border border-white/10 bg-surface-card py-2 pl-4 pr-12 font-semibold text-primary transition-all duration-150 ease-in-out hover:pl-10 hover:pr-6 group active:scale-95 " + (btnClass ? btnClass : '')}>
