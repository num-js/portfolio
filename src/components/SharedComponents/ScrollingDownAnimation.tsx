...
type ScrollingDownAnimationProps = {
    hiddenSection: string;
};

const ScrollingDownAnimation = ({ hiddenSection }: ScrollingDownAnimationProps) => {
    ...
    useEffect(() => {
        ...
        if (hideSectionElem) observer.observe(hideSectionElem);
